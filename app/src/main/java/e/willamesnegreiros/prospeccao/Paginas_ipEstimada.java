...
public class Paginas_ipEstimada extends FragmentStatePagerAdapter {
    ...
    public Paginas_ipEstimada(FragmentManager fm, int tabCount) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                Novo_ipEstimada novo_ipEstimada = new Novo_ipEstimada();
                return novo_ipEstimada;
            case 1:
